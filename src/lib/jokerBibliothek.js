...
//   1. „Narren", nie „Budget" (design/waehrungen.md Abschnitt 2).
...
export const NEIGUNGEN = [
  { key: "neutral", label: "Neutral", desc: "Keine Zielrichtung: gleich viele Narren für alle, jeder darf jeden treffen." },
  { key: "ausgleich", label: "Ausgleichend", desc: "Einsätze treffen nur, wer vorne steht — das bremst den Vorsprung, ohne die Narren selbst umzuverteilen." },
  { key: "underdog", label: "Underdog", desc: "Narren UND Ziele bevorzugen ausdrücklich, wer hinten liegt." },
];
...
export const KOMBINATIONEN = [
  ...
  },
  {
    key: "gleichgewicht",
    label: "Gleichgewicht",
    desc: "Der Normalfall. Gleich viele Narren für alle, Angriffe nur im letzten Drittel.",
    neigung: "ausgleich",
    dichte: "mittel",
    schaerfe: "zahm",
    budget: {
  ...
  },
  {
    ...
    desc: "Alles im Schlussspurt — die Narren sparen sich bis dahin an.",
    neigung: "ausgleich",
    dichte: "sparsam",
    schaerfe: "scharf",
    budget: {
  ...
  },
  {
    ...
    desc: "Narren für den Rückstand, Angriffe nur nach vorne. Die Runde jagt den Ersten.",
    neigung: "underdog",
    dichte: "mittel",
    schaerfe: "scharf",
    budget: {
