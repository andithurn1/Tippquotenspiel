...
export default function ErgebnisMatrix({ snap, rules, tip, onWahl, gesperrt = false, weite = null }) {
  ...
  // ⚠️ Hier stand bis zum 26.08.2026 die Favoriten-Sperre. Sie ist weg, und
  // zwar auf Ansage: „ich will keinen block ermöglichen bei ergebnissen, nur
  // Torschützen". Der Grund dahinter ist die Nähe-Belohnung — ein gesperrtes
  // 2:1 wäre über ein getipptes 2:0 doch bezahlt worden, die Sperre also durch
  // die Hintertür erreichbar. Im Raster ist ab hier wieder jedes Feld wählbar.
