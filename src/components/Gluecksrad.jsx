...
export default function Gluecksrad({ felder = [], anteile = [], ergebnisId = null, groesse = 240 }) {
  ...
  if (!segmente.length) {
    return (
      <div style={{ fontSize: "0.75rem", color: C.muted, lineHeight: 1.45, padding: "10px 0" }}>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
      ...
      {ziel && (
        <div style={{ fontFamily: MONO, fontSize: "0.8125rem", color: C.akzent, fontWeight: 700 }}>
          {ziel.label || "—"}
        </div>
      )}

      <div style={{ fontSize: "0.6875rem", color: C.muted, textAlign: "center", lineHeight: 1.45, maxWidth: 260 }}>
