  ...
  return (
    <div style={{
      ...
      <div style={{ width: "100%", maxWidth: 440 }}>
        ...
        <h1 style={{ fontSize: "1.375rem", fontWeight: 800, margin: "8px 0 6px" }}>Wie das Tippspiel funktioniert</h1>
        <p style={{ fontSize: "0.8125rem", color: C.muted, lineHeight: 1.6, marginTop: 0 }}>
        ...
        <Section n="2" title="So entstehen deine Punkte">
          ...
          <Details summary="Beispiele: verschiedene Ausgänge im Vergleich">
            ...
            <p style={{ fontSize: "0.6875rem", color: C.muted, lineHeight: 1.5 }}>
        ...
        <Section n="3" title="Für Admins: eigene Runde & Regeln">
          ...
          <Details summary="Admin-Beispiel: wie der Favoriten-Malus wirkt">
            <p style={{ fontSize: "0.75rem", color: C.muted, marginBottom: 8, lineHeight: 1.5 }}>
            ...
            {(() => {
              ...
              return base.tips.map((t, i) => (
                <div key={i} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "5px 0", borderTop: i === 0 ? "none" : `1px solid ${C.line}` }}>
                  <span style={{ fontSize: "0.8125rem" }}>{t.kind} <span style={{ fontFamily: MONO, color: C.muted }}>{t.tip.home}:{t.tip.away}</span></span>
...
const ulStyle = { margin: "6px 0", paddingLeft: 18, fontSize: "0.8125rem", lineHeight: 1.7, color: C.text };
const pStyle = { fontSize: "0.8125rem", color: C.text, lineHeight: 1.6, margin: "6px 0" };
    ...
    <div style={{ marginTop: 22, paddingTop: 18, borderTop: `1px solid ${C.line}` }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
        <span style={{
          ...
          fontFamily: MONO, fontSize: "0.75rem", fontWeight: 700, flexShrink: 0,
        }}>{n}</span>
...
function Ebene({ tone, label, desc }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
      ...
      <span style={{ fontSize: "0.8125rem" }}><b>{label}</b> <span style={{ color: C.muted }}>— {desc}</span></span>
    </div>
  );
}
...
const exampleHead = { fontFamily: MONO, fontSize: "0.6875rem", letterSpacing: 1, color: C.akzent, textTransform: "uppercase", marginBottom: 8 };

function ExRow({ tip, note, pts, tone }) {
  return (
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "3px 0" }}>
      <span style={{ fontSize: "0.8125rem" }}><span style={{ fontFamily: MONO, color: tone, fontWeight: 700 }}>{tip}</span> <span style={{ color: C.muted }}>· {note}</span></span>
      <span style={{ fontFamily: MONO, fontSize: "0.9375rem", fontWeight: 700, color: tone }}>{pts}</span>
    </div>
  );
}
...
function chip(best) {
  return {
    fontFamily: MONO, fontSize: "0.75rem", padding: "4px 8px", borderRadius: RUND.karte,
...
function Details({ summary, children }) {
  return (
    <details style={{ marginTop: 12, background: C.ink2, border: `1px solid ${C.line}`, borderRadius: RUND.karte, padding: "0 14px" }}>
      <summary style={{
        cursor: "pointer", padding: "12px 0", fontSize: "0.8125rem", fontWeight: 600, color: C.mint,
        listStyle: "none", display: "flex", alignItems: "center", gap: 8,
      }}>
        <span style={{ fontSize: "0.6875rem" }}>▶</span> {summary}
      </summary>
...
function cta(bg, color) {
  return {
    ...
    background: bg, color: color ?? C.ink, fontWeight: 700, fontSize: "0.9375rem",
