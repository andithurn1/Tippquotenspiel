    ...
    <div
      ...
      <div style={{
        ...
        <div style={{ padding: "16px 18px 10px" }}>
          ...
          <div style={{ fontSize: "1.0625rem", fontWeight: 800, color: C.text, marginTop: 4 }}>
            {summe.anzahl === 1 ? "Ein Spiel ist durch" : `${summe.anzahl} Spiele sind durch`}
          </div>
          <div style={{ fontSize: "0.8125rem", color: C.muted, marginTop: 3, lineHeight: 1.5 }}>
              ...
              <div key={s.matchId ?? `${s.wettbewerb}-${s.matchday}-${s.kickoff}`} style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontSize: "0.8125rem", color: C.text, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                      {s.home} – {s.away}
                    </div>
                  ...
                  <div style={{ fontFamily: MONO, fontSize: "0.9375rem", fontWeight: 700, color: s.punkte > 0 ? C.mint : C.muted }}>
                    {s.punkte}
                  </div>
                </div>
        ...
        <div style={{ padding: "12px 18px 16px", borderTop: `1px solid ${C.line}` }}>
          ...
          <button type="button" onClick={weiter} style={{
            ...
            background: C.mint, color: C.ink, fontSize: "0.9375rem", fontWeight: 800,
          ...
          {/* ⚠️ Der Hinweis gehört HIERHER und nicht ins Menü: wer die
              ...
              beim nächsten Mal. */}
          <div style={{ fontSize: "0.6875rem", color: C.muted, marginTop: 9, textAlign: "center", lineHeight: 1.5 }}>
