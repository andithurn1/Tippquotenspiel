...
export default function VariantenWahl({ rules, onWaehlen }) {
  ...
  return (
    <div style={{ marginBottom: 18 }}>
      <div style={{ fontSize: "0.9375rem", fontWeight: 700, marginBottom: 4 }}>
        Welche Variante willst du spielen?
      </div>
      <p style={{ fontSize: "0.8125rem", color: C.muted, marginTop: 0, marginBottom: 10, lineHeight: 1.5 }}>
      ...
      <div style={{ display: "flex", gap: 8 }}>
        {VARIANTEN.map((v) => {
          ...
          return (
            ...
            >
              <div style={{ fontSize: "0.9375rem", fontWeight: 700, color: an ? C.akzent : C.text }}>
                {v.titel}
              </div>
              <div style={{ fontSize: "0.75rem", marginTop: 3, lineHeight: 1.4 }}>{v.kurz}</div>
            </button>
          );
        })}
      </div>
      ...
      <p style={{ fontSize: "0.75rem", color: C.muted, marginTop: 8, marginBottom: 0, lineHeight: 1.5 }}>
