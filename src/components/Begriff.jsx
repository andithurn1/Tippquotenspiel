      ...
      {open && (
        <span
          ...
          style={{
            ...
            border: `1px solid ${C.lineStrong}`, borderRadius: RUND.karte, padding: "10px 12px",
            boxShadow: "0 18px 40px -18px rgba(0,0,0,0.85)", fontSize: "0.8125rem", lineHeight: 1.5,
        ...
        >
          <span style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", gap: 8, marginBottom: 4 }}>
            <strong style={{ color: C.akzent, fontSize: "0.75rem" }}>{entry.term}</strong>
            <button onClick={() => setOpen(false)} style={{
              background: "none", border: "none", color: C.muted, cursor: "pointer", fontSize: "0.9375rem", padding: 0, lineHeight: 1,
