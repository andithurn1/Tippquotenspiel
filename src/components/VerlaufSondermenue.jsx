  ...
  return (
    <div>
                ...
                {STAERKE_STUFEN.map((s) => {
                  ...
                  return (
                    <button key={s.key} onClick={() => setzeAufholen({ staerke: s.staerke, schwelle: s.schwelle })} style={{
                      ...
                      <div style={{ fontSize: "0.6875rem", opacity: 0.8, marginTop: 2, lineHeight: 1.3 }}>{s.hint}</div>
                    </button>
                  );
                })}
              </div>
      ...
      <GrosseZeile icon="📆" titel="Streicher &amp; Saisonverlauf" unter="was ein einzelnes Spiel wiegt"
        ...
        <p style={{ fontSize: "0.6875rem", color: C.muted, marginTop: 2, marginBottom: 10, lineHeight: 1.4 }}>
        ...
        {sf.streich > 0 && (
          <div style={{ paddingLeft: 12, borderLeft: `1px solid ${C.line}`, marginBottom: 10 }}>
            ...
            <p style={{ fontSize: "0.6875rem", color: sf.nurGetippte ? C.muted : C.coral, marginTop: 2, lineHeight: 1.4 }}>
              {sf.nurGetippte
        ...
        {sf.kurve !== "flach" && (
          <div style={{
            ...
            <div style={{ fontSize: "0.75rem", color: C.coral, fontWeight: 700, marginBottom: 3 }}>
        ...
        {(sf.kurve !== "flach" || sf.streich > 0) && (
          <p style={{
            fontSize: "0.75rem", color: C.text, marginTop: 4, marginBottom: 12, lineHeight: 1.45,
                ...
                {VERSAEUMNIS_STRATEGIEN.map((s) => {
                  ...
                  return (
                    <button key={s} onClick={() => setzeVersaeumnis({ strategie: s })} style={{
                      ...
                      <div style={{ fontSize: "0.6875rem", opacity: 0.8, marginTop: 2, lineHeight: 1.3 }}>{VERSAEUMNIS_HINT[s]}</div>
                    </button>
                  );
                })}
              </div>
