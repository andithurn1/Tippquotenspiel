...
| NS6 | Andis Bedenken: „wir haben halt auch dann so viele Parameter dass son Gesamtgamecode schnell mal über 200 Zeichen hat" | ⏳ | **Nachgemessen — er hat recht, und die Größenordnung ist 25× höher als befürchtet: 4 903 Zeichen.** Vorschlag dagegen: das Delta nicht gegen `DEFAULT_RULES` bilden, sondern gegen den CHARAKTER, von dem das Regelwerk abstammt (~300 statt 4 903). Preis: die Charakter-Fassung muss mit im Code stehen, sonst verschiebt sich die Bedeutung alter Codes still. Steht als ❓6 und in `design/roadmap.md` |
