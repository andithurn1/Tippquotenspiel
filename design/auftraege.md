...
| JK15 | **Alle Fremdjoker treffen EINZELNE SPIELE**, nicht ganze Spieltage | ⏳ | Gilt als gesetzt; steckt in Teil D. Die Folgefrage hat er selbst gestellt → JK16 |
| JK16 | ❓ **Wie geht das mit höher gewichteten Spielen (CL) zusammen?** Seine drei Vorschläge: Preis im Shop staffeln · Fremdjoker nur bei Gleichgewichtung · andere Lösung | 🔨 | **Empfehlung liegt vor** (`joker-sondermenue.md`, „Fremdjoker treffen EINZELNE SPIELE"): die WIRKUNG normieren statt den Preis — ein Fremdjoker rechnet auf dem Wert ohne die rundenweiten Gewichte. Preis-nach-Gewicht als Option, Sperre nein/Warnung ja, Deckel je Einsatz als Ergänzung. ⏳ Andi entscheidet, und dazu die Folgefrage, ob die Gegenwette mitzieht |
