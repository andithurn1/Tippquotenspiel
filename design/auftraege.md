...
| ST5 | **Kopfzeile: Bibliothek · Gamemode · GameCode einsetzen** | ✅ | Drei Chips in der klebenden Kopfzeile ( in ), jeder zeigt seinen STAND und springt zu seinem Abschnitt. Werte abgelesen statt gemerkt — kein zweiter Zustand. Im Browser geprüft: aus Position 1800 landet das Ziel exakt unter der Kopfzeile, „Wettbüro" wählen ändert 📚 und 🎮 sofort mit. Auf 375 px alle drei 44 px hoch, kein Querlauf |
