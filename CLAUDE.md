...
| `npm run schlank` | **Greift ein Screen an einen Schnappschuss, den er gar nicht geladen hat?** Seit dem 27.08.2026 laden 14 von 19 Screens den Katalog OHNE Quoten-Bild — **85 % weniger** (3138 → 467 KB, gemessen). ⚠️ Ein fehlender Schnappschuss stürzt NICHT ab, er zeigt still etwas Falsches; genau dagegen misst dieser Durchgang. | Der fette Teil (43 % `players`, 14 % `correctScore`) wurde bei JEDEM Öffnen mitgeschickt, obwohl ihn nur die Tippabgabe braucht — für EIN Spiel |
